...
describe("crypto", function() {
    describe("getCryptoResources", function() {
        it("returns expected methods", function() {
            ...
            expect(resources).to.have.property("crypto/v1/decryptBuffer").that.is.a("function");
            expect(resources).to.have.property("crypto/v1/encryptBuffer").that.is.a("function");
